...
import travelGirlImg from '../public/img/travelgirl.jpg';
    ...
    <>
      ...
      <Container className="flex flex-wrap justify-between items-center">
        <div className="w-full lg:w-1/2 px-6">
          <div className="mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Please fill out the form below to plan your journey.
            </p>
            <form className="w-full max-w-lg" onSubmit={handleOnSubmit}>
              <div className="flex flex-wrap -mx-3 mb-6">
                ...
                {/* <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0 flex items-center">
                  <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 mr-2">
                    Multi City
                  </label>
                  <input
                    type="radio"
              ...
              <div className="flex items-center justify-between">
                <button
                  className="px-8 py-4 text-lg font-medium text-center text-white bg-indigo-600 rounded-md hover:bg-indigo-500 focus:outline-none"
                  type="submit"
                >
                  Submit
                </button>
        ...
        <div className="w-full lg:w-1/2 px-6 flex justify-center items-center">
          ...
          />
          {/* <iframe
          src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fmadhavi.pathirage%2Fposts%2Fpfbid0MP91mXmLuxAKDAXcqZMSyZ7dNzMYLmKbAYKSomp6fp7afeyk6tZjzWWieZCe7pg4l&show_text=true&width=500"
          width="500"
          height="342"
